...
class Application < Sinatra::Base
  ...
  get '/' do
    @blogs = {  :atlantic => "test" #FashionBlog.new("Atlantic-Pacific", '.post-body .separator', "http://atlantic-pacific.blogspot.com", "http://facebook.com/atlanticpacificblog", "http://twitter.com/BlairEadieBEE", "http://instagram.com/blaireadiebee", "get_links")
