...
class Application < Sinatra::Base
  ...
  get '/' do
    @blogs = {  :atlantic => FashionBlog.new("Atlantic-Pacific", '.post-body .separator', "http://atlantic-pacific.blogspot.com", "http://facebook.com/atlanticpacificblog", "http://twitter.com/BlairEadieBEE", "http://instagram.com/blaireadiebee", "get_links"),
                ...
                :wendy_lookbook => FashionBlog.new("Wendy's Lookbook", '.wlb_image_preview a', "http://www.wendyslookbook.com/", "http://www.facebook.com/wendyslookbook", "http://twitter.com/wendynguyen", "http://instagram.com/wendyslookbook", "get_links_img"),
                ...
                :toast => FashionBlog.new("Fashiontoast", '.copy p', "http://fashiontoast.com/", "http://www.facebook.com/fashiontoast", "http://twitter.com/rumineely", "http://instagram.com/rumineely", "get_links_img"),
                :navy => FashionBlog.new("Something Navy", '.cb-excerpt p', "http://www.somethingnavy.com/", "http://www.facebook.com/pages/SomethingNavy/108772859186758?ref=ts&fref=ts", "http://twitter.com/something_navy", "http://instagram.com/somethingnavy", "get_links_img"),
